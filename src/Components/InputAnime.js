...
const InputAnime = () => {
    ...
    return (
        ...
        <form className="d-flex mt-5" onSubmit={onSubmitForm}>
            <input type="text" className="form-control mx-1" value={animeName} name="animeName" onChange={handleOnChange} placeholder="Anime name"/>
            <input type="text" className="form-control mx-1" value={description} name="description" onChange={handleOnChange} placeholder="Description"/>
