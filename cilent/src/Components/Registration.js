...
const Registration = ({ preFilledData }) => {
  ...
  const initialValues = {
    firstName: preFilledData ? preFilledData.data.first_name : "",
    lastName: preFilledData ? preFilledData.data.last_name : "",
    email: preFilledData ? preFilledData.data.email : "",
    password: preFilledData ? preFilledData.data.password : "",
    confirmPassword: "",
    gender: "",
    smoke: "",
    dob: "",
  ...
  return (
    <>
      <div className="container text-center my-3">
        ...
        <Link to="/">
          <button className="my-3">Back to Home</button>
        </Link>
      </div>
